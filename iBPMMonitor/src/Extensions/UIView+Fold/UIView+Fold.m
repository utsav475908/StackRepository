...
- (void)foldClosedWithTransparency:(BOOL)withTransparency
    ...
    [self _foldWithTransparency:withTransparency
...
- (void)_foldWithTransparency:(BOOL)withTransparency
            completionBlock:(void (^)(void))completionBlock
                  inDirection:(FoldDirection)foldDirection{
    NSArray *topAndBottomView = [self _prepareSplitImage];
