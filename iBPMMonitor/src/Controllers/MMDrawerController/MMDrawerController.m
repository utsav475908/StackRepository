...
typedef BOOL (^MMDrawerGestureShouldRecognizeTouchBlock)
    (MMDrawerController * drawerController, UIGestureRecognizer * gesture, UITouch * touch);
typedef void (^MMDrawerGestureCompletionBlock)
    (MMDrawerController * drawerController, UIGestureRecognizer * gesture);


// *************************************************************************************************
// # MARK: Private Interfaces - MMDrawerCenterContainerView
...
// *************************************************************************************************
// # MARK: Implementation - MMDrawerCenterContainerView
...
// *************************************************************************************************
// # MARK: Private Interfaces - MMDrawerController
...
// *************************************************************************************************
// # MARK: Implementation - MMDrawerController
...
-(void)closeDrawerAnimated:(BOOL)animated completion:(void (^)(BOOL finished))completion {
    [self closeDrawerAnimated:animated velocity:self.animationVelocity
             animationOptions:UIViewAnimationOptionCurveEaseInOut
                   completion:completion];
}


-(void)closeDrawerAnimated:(BOOL)animated velocity:(CGFloat)velocity
    ...
    if(self.isAnimatingDrawer){
        ...
        if(leftDrawerVisible){
            ...
            CGFloat visibleDrawerPoints =
                CGRectGetWidth(self.centerContainerView.frame) - CGRectGetMaxX(self.centerContainerView.frame);
...
-(void)openDrawerSide:(MMDrawerSide)drawerSide
    ...
    [self openDrawerSide:drawerSide animated:animated
...
// *************************************************************************************************
// # MARK: Setting Drawer Visual State
...
// *************************************************************************************************
// # MARK: Setting Custom Gesture Handler Block


-(void)setGestureShouldRecognizeTouchBlock:(BOOL (^)(MMDrawerController *,
                                                     UIGestureRecognizer *,
...
// *************************************************************************************************
// # MARK: Setting the Gesture Completion Block
...
static inline CGFloat originXForDrawerOriginAndTargetOriginOffset(CGFloat originX,
    ...
    CGFloat overshoot = nonLinearRange +
        nonLinearScalingDelta * nonLinearRange/sqrt(pow(nonLinearScalingDelta,2.f) + 15000);
...
// *************************************************************************************************
// # MARK: Gesture Recogizner Delegate Helpers
