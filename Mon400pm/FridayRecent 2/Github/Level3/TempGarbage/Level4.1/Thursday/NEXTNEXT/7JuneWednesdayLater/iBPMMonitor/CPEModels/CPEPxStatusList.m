...
@interface CPEPxStatusList ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation CPEPxStatusList
...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.pzIndexes = [CPEPzIndexes modelObjectWithDictionary:[dict objectForKey:kPxStatusListPzIndexes]];
...
- (id)copyWithZone:(NSZone *)zone {
    CPEPxStatusList *copy = [[CPEPxStatusList alloc] init];
