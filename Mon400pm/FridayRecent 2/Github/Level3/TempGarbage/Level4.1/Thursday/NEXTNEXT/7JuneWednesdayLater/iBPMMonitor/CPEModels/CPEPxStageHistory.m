...
@interface CPEPxStageHistory ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation CPEPxStageHistory
    ...
    if ([receivedPxProcesses isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPxProcesses) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPxProcesses addObject:[CPEPxProcesses modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPxProcesses isKindOfClass:[NSDictionary class]]) {
       [parsedPxProcesses addObject:[CPEPxProcesses modelObjectWithDictionary:(NSDictionary *)receivedPxProcesses]];
    }
...
- (id)copyWithZone:(NSZone *)zone {
    CPEPxStageHistory *copy = [[CPEPxStageHistory alloc] init];
