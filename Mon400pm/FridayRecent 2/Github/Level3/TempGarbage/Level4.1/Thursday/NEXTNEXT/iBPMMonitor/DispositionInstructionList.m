...
#import "DispositionInstructionList.h"
#import "PzIndexes.h"
...
@interface DispositionInstructionList ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation DispositionInstructionList
...
- (id)copyWithZone:(NSZone *)zone {
    DispositionInstructionList *copy = [[DispositionInstructionList alloc] init];
