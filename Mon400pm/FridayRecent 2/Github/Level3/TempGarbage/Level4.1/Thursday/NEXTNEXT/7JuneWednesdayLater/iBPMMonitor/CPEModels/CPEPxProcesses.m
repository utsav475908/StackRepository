...
@interface CPEPxProcesses ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation CPEPxProcesses
    ...
    if ([receivedPxSteps isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPxSteps) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPxSteps addObject:[CPEPxSteps modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPxSteps isKindOfClass:[NSDictionary class]]) {
       [parsedPxSteps addObject:[CPEPxSteps modelObjectWithDictionary:(NSDictionary *)receivedPxSteps]];
    }
...
- (id)copyWithZone:(NSZone *)zone {
    CPEPxProcesses *copy = [[CPEPxProcesses alloc] init];
