...
#import "CPESFDCCaseDetails.h"
#import "CPEPxCorrSummary.h"
#import "CPEPartialShipsetList.h"
#import "CPEPxStageHistory.h"
#import "CPEElectronicShipSetList.h"
#import "CPEPxResolveSummary.h"
#import "CPEPxStatusList.h"
#import "CPEPyWorkParty.h"
#import "CPEPxFlow.h"
...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.sFDCCaseDetails = [CPESFDCCaseDetails modelObjectWithDictionary:[dict objectForKey:kBaseClassSFDCCaseDetails]];
    ...
    if ([receivedPxCorrSummary isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPxCorrSummary) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPxCorrSummary addObject:[CPEPxCorrSummary modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPxCorrSummary isKindOfClass:[NSDictionary class]]) {
       [parsedPxCorrSummary addObject:[CPEPxCorrSummary modelObjectWithDictionary:(NSDictionary *)receivedPxCorrSummary]];
    }
    ...
    if ([receivedPartialShipsetList isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPartialShipsetList) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPartialShipsetList addObject:[CPEPartialShipsetList modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPartialShipsetList isKindOfClass:[NSDictionary class]]) {
       [parsedPartialShipsetList addObject:[CPEPartialShipsetList modelObjectWithDictionary:(NSDictionary *)receivedPartialShipsetList]];
    }
    ...
    if ([receivedPxStageHistory isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPxStageHistory) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPxStageHistory addObject:[CPEPxStageHistory modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPxStageHistory isKindOfClass:[NSDictionary class]]) {
       [parsedPxStageHistory addObject:[CPEPxStageHistory modelObjectWithDictionary:(NSDictionary *)receivedPxStageHistory]];
    }
    ...
    if ([receivedElectronicShipSetList isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedElectronicShipSetList) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedElectronicShipSetList addObject:[CPEElectronicShipSetList modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedElectronicShipSetList isKindOfClass:[NSDictionary class]]) {
       [parsedElectronicShipSetList addObject:[CPEElectronicShipSetList modelObjectWithDictionary:(NSDictionary *)receivedElectronicShipSetList]];
    }
    ...
    if ([receivedPxResolveSummary isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPxResolveSummary) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPxResolveSummary addObject:[CPEPxResolveSummary modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPxResolveSummary isKindOfClass:[NSDictionary class]]) {
       [parsedPxResolveSummary addObject:[CPEPxResolveSummary modelObjectWithDictionary:(NSDictionary *)receivedPxResolveSummary]];
    }
    ...
    if ([receivedPxStatusList isKindOfClass:[NSArray class]]) {
        for (NSDictionary *item in (NSArray *)receivedPxStatusList) {
            if ([item isKindOfClass:[NSDictionary class]]) {
                [parsedPxStatusList addObject:[CPEPxStatusList modelObjectWithDictionary:item]];
            }
       }
    } else if ([receivedPxStatusList isKindOfClass:[NSDictionary class]]) {
       [parsedPxStatusList addObject:[CPEPxStatusList modelObjectWithDictionary:(NSDictionary *)receivedPxStatusList]];
    }
    ...
    self.pxStatusList = [NSArray arrayWithArray:parsedPxStatusList];
            ...
            self.pyWorkParty = [CPEPyWorkParty modelObjectWithDictionary:[dict objectForKey:kBaseClassPyWorkParty]];
            ...
            self.pxFlow = [CPEPxFlow modelObjectWithDictionary:[dict objectForKey:kBaseClassPxFlow]];
