...
@class CPESFDCCaseDetails, CPEPyWorkParty, CPEPxFlow;
...
@property (nonatomic, strong) CPESFDCCaseDetails *sFDCCaseDetails;
...
@property (nonatomic, strong) CPEPyWorkParty *pyWorkParty;
...
@property (nonatomic, strong) CPEPxFlow *pxFlow;
